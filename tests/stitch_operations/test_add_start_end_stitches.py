...
from stitch_generator.stitch_operations.add_start_end_stitches import (
...
@pytest.mark.parametrize(
    "number_of_segments, number_of_repeated_segments",
    [(10, 3), (10, 5), (100, 1), (100, 0), (3, 3)],
)
def test_add_start_end_stitches(number_of_segments, number_of_repeated_segments):
    ...
    with_start_end = add_start_end_stitches(
        stitches, repeated_segments=number_of_repeated_segments
    )
