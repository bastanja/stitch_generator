...
from stitch_generator.shapes.rounded_rect import (
    simple_rounded_rect,
...
@pytest.mark.parametrize("width, height, corner_radii", [(5, 5, (1, 0, 1, 0))])
def test_rounded_rect_with_corner_radii(width, height, corner_radii):
    shape, direction = rounded_rect_with_corner_radii(
        width=width, height=height, corner_radii=corner_radii
    )
