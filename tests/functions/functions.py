from stitch_generator.collection.functions.functions_1d import (
    linear_0_1,
    linear_1_0,
    positive_sine,
    positive_cosine,
    half_positive_sine,
    half_positive_cosine,
    half_circle,
    cubic_arc,
    three_stairs,
    half_peak,
...
functions_1d_negative = {"sin": sinus, "cos": cosinus, "noise": noise()}
...
functions_2d = {
    ...
    "bezier_seq": function_sequence(
        (
            bezier_shape(((0, 0), (10, -10), (20, 0))),
            bezier_shape(((20, 0), (30, 10), (40, 0))),
        ),
        (1, 1),
    ),
}
