...
from stitch_generator.collection.stitch_effects.motif_stitches import stem_stitch, e_stitch, three_arrows, arrow_chain, \
    cretan_stitch, feather_stitch, rhomb_motif_stitch, x_motif_stitch, alternating_triangles, chevron_stitch, overlock_stitch
...
class Design(EmbroideryDesign):
    ...
    def _to_pattern(self, parameters, pattern):
        ...
        effects = [
            ...
            overlock_stitch(spacing=parameters.spacing, width=parameters.spacing, height=5)
        ]
