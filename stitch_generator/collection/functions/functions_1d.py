...
from stitch_generator.functions.function_modifiers import subtract, repeat, combine
...
positive_sine = combine(sinus, linear_interpolation(0, 1, source_low=-1, source_high=1))
positive_cosine = combine(sinus, linear_interpolation(0, 1, source_low=-1, source_high=1))
