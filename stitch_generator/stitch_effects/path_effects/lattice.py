...
def lattice_along(path: Path, strands: int, pattern_f: Function1D, pattern_length: float) -> Coordinates:
...
def _lattice(path: Path, strands: int, length: float, pattern_f: Function1D, pattern_length: float, stitch_length: float) -> Coordinates:
...
def _calculate_stitch_length(pattern_length: float, strands: int, desired_length: float = 2) -> float:
