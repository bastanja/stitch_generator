...
def get_tatami():
    return alternating_tatami_sampling(stitch_length=4, include_endpoint=True, offsets=(0, 1 / 3, 2 / 3), alignment=0.5,
...
def stitch_effects(length: float):
    ...
    yield partial(repeat_along, repetitions=11, sampling_function=get_tatami(), length=length, step_ratio=0.1)
