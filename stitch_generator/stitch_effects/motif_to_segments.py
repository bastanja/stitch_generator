...
def motif_to_segments(motif_position_sampling: SamplingFunction, line_sampling: SamplingFunction, motif_generator,
                      length: float):
    return partial(_motif_to_segments, motif_position_sampling=motif_position_sampling, line_sampling=line_sampling,
                   motif_generator=motif_generator, length=length)


def _motif_to_segments(path: Path, motif_position_sampling: SamplingFunction, line_sampling: SamplingFunction,
