...
from stitch_generator.framework.types import SamplingFunction, Array2D, Function1D, Function2D
...
def motif_chain(motif_position_sampling: SamplingFunction, motif_generator,
                motif_rotation_degrees: Function1D) -> StitchEffect:
    return lambda path: motif_chain_on_shape(path.shape, path.direction,
...
def motif_chain_on_shape(shape: Function2D, direction: Function2D, motif_position_sampling: SamplingFunction,
