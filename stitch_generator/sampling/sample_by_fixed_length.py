...
def sample_by_fixed_length(total_length: float, segment_length: float, alignment: float = 0, offset: float = 0,
                           minimal_segment_size: float = 0) -> Array1D:
...
def sampling_by_fixed_length(segment_length: float, alignment: float = 0, offset: float = 0,
                             minimal_segment_size: float = 0) -> SamplingFunction:
